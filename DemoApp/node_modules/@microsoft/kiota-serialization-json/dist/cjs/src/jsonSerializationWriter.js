...
class JsonSerializationWriter {
    ...
    writeObjectValue(key, value, serializerMethod) {
        if ((0, kiota_abstractions_1.isUntypedNode)(value)) {
            const untypedNode = value;
            if ((0, kiota_abstractions_1.isUntypedBoolean)(untypedNode)) {
                this.writeBooleanValue(key, untypedNode.getValue());
            }
            else if ((0, kiota_abstractions_1.isUntypedString)(untypedNode)) {
                this.writeStringValue(key, untypedNode.getValue());
            }
            else if ((0, kiota_abstractions_1.isUntypedNull)(untypedNode)) {
                this.writeNullValue(key);
            }
            else if ((0, kiota_abstractions_1.isUntypedNumber)(untypedNode)) {
                this.writeNumberValue(key, untypedNode.getValue());
            }
            else if ((0, kiota_abstractions_1.isUntypedObject)(untypedNode)) {
                ...
                for (const key in value) {
                    this.writeObjectValue(key, value[key], serializerMethod);
                }
            ...
            else if ((0, kiota_abstractions_1.isUntypedArray)(untypedNode)) {
                if (key) {
                    this.writePropertyName(key);
                }
                const value = untypedNode.getValue();
