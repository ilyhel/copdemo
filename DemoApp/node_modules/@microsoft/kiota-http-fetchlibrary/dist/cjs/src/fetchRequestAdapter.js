...
class FetchRequestAdapter {
    ...
    constructor(authenticationProvider, parseNodeFactory = kiota_abstractions_1.ParseNodeFactoryRegistry.defaultInstance, serializationWriterFactory = kiota_abstractions_1.SerializationWriterFactoryRegistry.defaultInstance, httpClient = new httpClient_1.HttpClient(), observabilityOptions = new observabilityOptions_1.ObservabilityOptionsImpl()) {
        ...
        this.sendEnum = (requestInfo, enumObject, errorMappings) => {
            ...
            return this.startTracingSpan(requestInfo, "sendEnum", (span) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    const response = yield this.getHttpResponseMessage(requestInfo, span);
                    const responseHandler = this.getResponseHandler(requestInfo);
                    if (responseHandler) {
                        ...
                        try {
                            ...
                            if (this.shouldReturnUndefined(response))
                                return undefined;
                            const rootNode = yield this.getRootParseNode(response);
                            return api_1.trace.getTracer(this.observabilityOptions.getTracerInstrumentationName()).startActiveSpan("getEnumValue", (deserializeSpan) => {
                                try {
        ...
        this.sendCollectionOfEnum = (requestInfo, enumObject, errorMappings) => {
            ...
            return this.startTracingSpan(requestInfo, "sendCollectionOfEnum", (span) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    const response = yield this.getHttpResponseMessage(requestInfo, span);
                    const responseHandler = this.getResponseHandler(requestInfo);
                    if (responseHandler) {
                        ...
                        try {
                            ...
                            if (this.shouldReturnUndefined(response))
                                return undefined;
                            const rootNode = yield this.getRootParseNode(response);
                            return api_1.trace.getTracer(this.observabilityOptions.getTracerInstrumentationName()).startActiveSpan("getCollectionOfEnumValues", (deserializeSpan) => {
                                try {
