...
export declare class MultipartSerializationWriter implements SerializationWriter {
    ...
    writeCollectionOfPrimitiveValues: <T>(_key?: string, _values?: T[]) => void;
    writeCollectionOfObjectValues: <T extends Parsable>(_key?: string, _values?: T[]) => void;
