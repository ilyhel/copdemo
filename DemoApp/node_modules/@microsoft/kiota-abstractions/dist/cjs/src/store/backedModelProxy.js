...
exports.createBackedModelProxyHandler = void 0;
const backingStoreFactorySingleton_1 = require("./backingStoreFactorySingleton");
// A method that creates a ProxyHandler for a generic model T and attaches it to a backing store.
function createBackedModelProxyHandler() {
    // Each model has a backing store that is created by the BackingStoreFactorySingleton
    const backingStore = backingStoreFactorySingleton_1.BackingStoreFactorySingleton.instance.createBackingStore();
    /**
...
exports.createBackedModelProxyHandler = createBackedModelProxyHandler;
