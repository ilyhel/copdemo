...
export declare class TextSerializationWriter implements SerializationWriter {
    ...
    writeCollectionOfPrimitiveValues: <T>(key?: string, values?: T[]) => void;
    writeCollectionOfObjectValues: <T extends Parsable>(key?: string, values?: T[], serializerMethod?: ModelSerializerFunction<T>) => void;
    writeObjectValue: <T extends Parsable>(key?: string, value?: T, serializerMethod?: ModelSerializerFunction<T>) => void;
